...
class EurobudDbRouter:
    ...
    def allow_migrate(self, db, app_label, model_name=None, **hints):
        ...
        # app_list = ('forming_db_kl', 'foaming_db_kl', 'forming_db_kr', 'foaming_db_kr')
        # if db == 'default' and app_label not in app_list:
        if db == 'default' and app_label != 'forming_kl' and app_label != 'forming_kr' and app_label != 'foaming_kl' and app_label != 'foaming_kr':
            return True
        return False
